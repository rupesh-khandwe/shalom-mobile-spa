...
const Profile = ({route, navigation}) => {
  ...
  console.log("Profile loaded", userName, userInfo.userName, userInfo.firstName)
      ...
      for ( var key in extUserObj) {
         ...
         if(extUserId===userInfo.userId){
          console.log("extUserId matched==",extUserId)
          setShowExternalFlag(false);
         } else {
          console.log("extUserId NOT matched==",extUserId)
  ...
  return (
    ...
    >
      ...
      {!showExternalFlag &&<View style={styles.camDiv}>
